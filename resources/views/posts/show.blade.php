...
@section('content')
    ...
    <div class="post-section top d-flex sm-flex-direction-column">
        ...
        <div class="section-item info">
            ...
            <div class="mt-2">
             ...
             @if(Auth::check())
                @if(Auth::user()->id == $post->user_id)
                    <a href="/posts/{{$post->id}}/edit" class="btn btn-default"><i class="fa fa-edit"></i> Edit</a>
    ...
    <div class="post-section bottom mt-2 mb-2">
        <ul class="section-item content-menu">
            <li class="menu active" data-menu="description">Description</li>
            <li class="menu" data-menu="ratings">Ratings ({{ $post->countRating() }})</li>
        </ul>
        <div class="section-item content">
            <div class="wordwrap p-2 item active" data-item="description">
                 {!! $post->body !!}
            </div>
